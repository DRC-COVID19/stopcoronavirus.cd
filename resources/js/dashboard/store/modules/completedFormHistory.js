  ...
  actions: {
    completedFormHistoryIndex({ commit }, payload) {
      ...
      return new Promise((resolve, reject) => {
        axios
          .get(
            '/api/dashboard/completed-form-histories/get-completed-form-by-conflict',
            {
              params: payload,
            }
          )
    ...
    getNotificationCompletedFormHistories({ commit }, payload) {
      ...
      return new Promise((resolve, reject) => {
        axios
          .get(
            '/api/dashboard/completed-form-histories/get-notification-conflict'
          )
          .then(({ data }) => {
    ...
    completedFormHistoryStore(_, payload) {
      return new Promise((resolve, reject) => {
        ...
        axios
          .post(
            '/api/dashboard/completed-form-histories/store-completed-form-history',
            payload
          )
          .then(({ data }) => {
            resolve(data);
