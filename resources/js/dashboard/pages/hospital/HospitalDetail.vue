      ...
      <b-row v-else align-h="center" class="mb-2">
        <b-col cols="12" md="8" class="mt-4">
                  ...
                  <div class="d-flex flex-wrap">
                    ...
                    <div class="font-weight-bold">
                      <div v-if="formField.form_field_type.name === 'boolean'">
                        <span
                          v-if="
                            completedForm.completed_form_fields[
                              formField.id
                            ] !== null &&
                            completedForm.completed_form_fields[
                              formField.id
                      ...
                      <div
                        v-else-if="formField.form_field_type.name === 'date'"
                      >
                        <span
                          v-if="
                            completedForm.completed_form_fields[
          ...
          <div class="ml-3 mt-2">
            ...
            <strong>
              {{ completedForm.created_manager_name }}
              {{ completedForm.created_manager_first_name }}</strong
            >
          </div>
              ...
              >
                <li>
                  <strong>
                    ...
                    {{ item.updated_manager_first_name }} </strong
        ...
        return this.completedFormFields
          .map((completedFormField) => ({
            ...
            updated_manager_first_name:
              completedFormField.updated_manager_first_name,
          ...
          .filter(
            (item, i, self) =>
              item.updated_manager_name &&
              self.findIndex(
                (x) => x.updated_manager_name === item.updated_manager_name
              ) === i
          );
      }
      return [];
