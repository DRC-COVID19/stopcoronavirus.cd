      ...
      <b-row align-h="center">
        ...
        <b-col cols="12" md="6">
          <b-form @submit.prevent="submitForm">
            ...
            >
              <label class="text-dash-color" for="foam_beds"
                >Total lits avec mousse</label
              >
              <b-form-input
            ...
            <b-form-group
              :invalid-feedback="
                errors.resuscitation_beds ? errors.resuscitation_beds[0] : null
              "
              :state="
                errors.resuscitation_beds &&
                errors.resuscitation_beds.lenght > 0
              "
            >
              <label class="text-dash-color" for="resuscitation_beds"
                >Total lits de réanimation</label
              >
              <b-form-input
            ...
            <b-form-group
              :invalid-feedback="
                errors.respirators ? errors.respirators[0] : null
              "
              :state="errors.respirators && errors.respirators.lenght > 0"
            >
              <label class="text-dash-color" for="respirators"
                >Total respirateurs</label
              >
              <b-form-input
            ...
            >
              <label class="text-dash-color" for="doctors"
                >Nombre medecins</label
              >
              <b-form-input
            ...
            >
              <label class="text-dash-color" for="nurses"
                >Nombre Infirmiers</label
              >
              <b-form-input
                v-model="form.nurses"
                :disabled="isSubmitting"
            ...
            <b-form-group
              :invalid-feedback="
                errors.para_medicals ? errors.para_medicals[0] : null
              "
              :state="errors.para_medicals && errors.para_medicals.lenght > 0"
            >
              <label class="text-dash-color" for="para_medicals"
                >Nombre para-medicals</label
              >
              <b-form-input
