              ...
              <template v-slot="{ inputEvents, inputValue }">
                <div class="d-flex">
                  ...
                  <b-form-input
                    :value="
                      inputValue
                        ? moment(form.date_conflict).format('YYYY-MM-DD')
        ...
        <b-col>
          ...
          >
            ...
            <template v-slot:cell(status)="data">
              <b-badge v-if="data.item.conflict" pill variant="danger"
                >Non résolus</b-badge
              >
...
export default {
  ...
  computed: {
    ...mapState({
      completedFormHistories: (state) =>
        state.completedFormHistory.completedFormHistories,
  ...
  methods: {
    ...
    async getCompletedFormHistories(page = 1) {
      ...
      try {
        ...
        this.completedFormHistorie = await this.completedFormHistoryIndex(
          this.allCurrentFilters
        );
