<template>
  <b-container>
    <b-row class="form_card-list">
      ...
      <b-container v-else>
        <b-row
          class="mt-4 px-md-3 d-flex justify-content-start"
          v-if="getFormListLength > 0"
        >
          <b-col
            v-for="(form, index) in formsList.data"
            :key="index"
            md="3"
            sm="12 mt-4"
          >
        ...
        <b-row class="mt-5 px-md-3 d-flex justify-content-center" v-else>
          <b-col md="10 mt-5" sm="12 mt-5">
