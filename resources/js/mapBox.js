  ...
  values.map((item) => {
    ...
    switch (sondage) {
      ...
      case 'price_increase':
        ...
        const not_price_increase = item.not_price_increase ? item.not_price_increase : 0
      ...
      case 'antibacterial_gel':
        const antibacterial_gel = item.antibacterial_gel ? item.antibacterial_gel : 0
        const not_antibacterial_gel = item.not_antibacterial_gel ? item.not_antibacterial_gel : 0
        const antibacterial_gel_count = antibacterial_gel + not_antibacterial_gel
