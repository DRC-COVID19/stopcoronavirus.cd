...
function drawChart () {
  ...
  const jsonData = $.ajax({
    ...
    const labels = []; const data = []; const sick = []; const confirmed = []; const dead = []; const healed = []
    ...
    const myLineChart = new Chart(ctx, tempData)
  })
}
...
$(document).ready(function () {
  ...
  const response = $('#question-form-validate-btn').data('response')
