...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/flux/hotspots/maps');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/flux/hotspots/daily');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/health-zones');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/hospital-situations');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/hospitals-data');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/hospitals-data/1');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/hospitals');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/hospitals/evolution/');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/hospitals/totaux');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/indicators/zones');
...
```json
{
  "message": "The given data was invalid.",
  "errors": {
    "x": ["Le champ x est obligatoire."],
    "y": ["Le champ y est obligatoire."],
    "geoOptions": ["Le champ geo options est obligatoire."],
    "observation_start": ["Le champ observation start est obligatoire."],
    "observation_end": ["Le champ observation end est obligatoire."]
  }
}
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/sondages');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/cavid-cases');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/flux-24');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/flux-24-daily');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/flux-zone');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/flux-provinces');
...
```javascript
const url = new URL('http://localhost:8000/api/dashboard/townships');
