...
class CreateCompletedFormFieldHistoriesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('completed_form_field_histories', function (Blueprint $table) {
            $table->id();
            $table->string('value');
            ...
            $table->foreign('completed_form_history_id')->references('id')->on('completed_form_histories');
