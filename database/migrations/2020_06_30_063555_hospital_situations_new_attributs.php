  ...
  public function up()
  {
    Schema::table('hospital_situations', function (Blueprint $table) {
      ...
      $table
        ...
        ->nullable();
      $table
        ->integer('occupied_foam_beds')
        ->default(0)
        ->nullable();
      $table
        ->integer('occupied_resuscitation_beds')
        ->default(0)
        ->nullable();
      $table
        ->integer('individual_protection_equipment')
        ->default(0)
        ->nullable();
      $table
        ->integer('gel_hydro_alcoolique')
        ->default(0)
        ->nullable();
      $table
        ->integer('resuscitation_ventilator')
        ->default(0)
        ->nullable();
      $table
        ->integer('oxygenator')
        ...
        ->nullable();
      $table
        ->integer('rapid_screening')
        ->default(0)
        ->nullable();
      $table
        ->integer('automate_genexpert')
        ->default(0)
        ->nullable();
      $table
        ->integer('x_ray')
      ...
      $table
        ...
        ->nullable();
      $table
        ->integer('hydrochloroquine')
        ->default(0)
        ->nullable();
      $table
        ->integer('azytromicine')
        ->default(0)
        ->nullable();
      $table
        ->integer('Vitamince_c')
