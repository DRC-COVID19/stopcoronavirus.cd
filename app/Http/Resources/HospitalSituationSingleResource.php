...
class HospitalSituationSingleResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'reserved_resuscitation_beds_covid_19' => $this->reserved_resuscitation_beds_covid_19,
            'occupied_resuscitation_beds_covid_19' => $this->occupied_resuscitation_beds_covid_19,
            'individual_protection_equipment' => $this->individual_protection_equipment,
            'gel_hydro_alcoolique' => $this->gel_hydro_alcoolique,
            "resuscitation_ventilator" => $this->resuscitation_ventilator,
            "reserved_resuscitation_ventilator_covid_19" => $this->reserved_resuscitation_ventilator_covid_19,
            "occupied_resuscitation_ventilator_covid_19" => $this->occupied_resuscitation_ventilator_covid_19,
