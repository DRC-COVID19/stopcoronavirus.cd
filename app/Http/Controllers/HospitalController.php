...
class HospitalController extends Controller
{
  ...
  {
    $formsAllVisibility = Form::with(['completedForms' => function ($query) use ($hospital_id) {
    ...
    $hospitalForms = Hospital::with(['forms.completedForms' => function ($query)  use ($hospital_id) {
