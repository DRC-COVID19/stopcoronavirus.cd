...
class NotificationController extends Controller
{
  ...
  public function getNotificationNotReadUser($hospital_id)
  {
    ...
    $notificationsNotRead = $notifications->filter(function (
      $notification
    ) use ($userId) {
      return !$notification->adminUsers->first(function ($adminUser) use (
        $userId
      ) {
  ...
  public function setNotificationByHospital(
    $hospital_id,
    Notification $notification
  ) {
    $userId = $this->guard()->user()->id;
    $notificationNotReads = $this->getNotificationNotReadUser($hospital_id)
      ->original;
