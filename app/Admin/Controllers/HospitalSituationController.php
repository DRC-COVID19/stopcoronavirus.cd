...
class HospitalSituationController extends AdminController
{
  ...
  protected function grid()
  {
    ...
    $grid
      ->column('hospital_id', __('Hospital'))
      ->display(function ($hospital_id) {
  ...
  {
    $situations = HospitalSituation::with('hospital')
  ...
  public function journalier_show(
    HospitalSituation $situation,
    Content $content
  ) {
    return $content
      ->header('Hopitaux')
