...
class PandemicController extends AdminController
{
  ...
  protected function grid()
  {
    ...
    $grid
      ->column('health_zone_id', __('Zone'))
      ->display(function ($health_zone_id) {
  ...
  protected function form()
  {
    ...
    $form
      ->select('health_zone_id', __('Zone de santé'))
      ->options(HealthZone::pluck('name', 'id'))
      ->rules(['required']);
    $form
      ->datetime('last_update', __('Dernière modification'))
      ->rules(['required']);
