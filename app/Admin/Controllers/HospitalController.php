...
class HospitalController extends AdminController
{
  ...
  protected function form()
  {
    ...
    $form
      ->number('foam_beds', __('Total Lits avec mouse'))
      ->rules(['required']);
    $form
      ->number('resuscitation_beds', __('Total Lits de réanimation'))
      ->rules(['required']);
    ...
    $form
      ->number('para_medicals', __('Nombre para-medicals'))
      ->rules(['required']);
    $form
      ->select('agent_id', __('Agent'))
      ->options(function () {
