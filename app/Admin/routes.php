...
Admin::routes();
Route::resource('admin/auth/users', UserController::class)->middleware(
...
Route::group(
  ...
  function (Router $router) {
    ...
    Route::get('/dashboard-maps', 'DashBoardController@index')->name(
      'dashboard'
    );
    Route::get(
      '/situation-journalier',
      'HospitalSituationController@journalier'
    )->name('situation_journalier');
    Route::get(
      '/situation-journalier/{situation}',
      'HospitalSituationController@journalier_show'
    )->name('situation_journalier.show');
