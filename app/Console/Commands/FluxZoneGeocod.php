...
class FluxZoneGeocod extends Command
{
  ...
  public function handle()
  {
    ...
    $provinces = DB::select(
      'SELECT origin FROM flux24_provinces UNION SELECT destination AS origin FROM flux24_provinces'
    );
  ...
  public function getGeocodong($place)
  {
    try {
      ...
      $response = $client->request(
        'GET',
        "https://maps.googleapis.com/maps/api/geocode/json?address={$place}&key=AIzaSyB9bIZWto9SNNpq3cEEGbaudwXnOQS6kg8&components=country:CD"
      );
